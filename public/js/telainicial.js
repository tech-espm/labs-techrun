    ...
    constructor(game) {
        this.init = function () {
            ...
            if (game.device.desktop) {
                ...
                game.scale.setMinMax(400, 300, 1920, 1200);
        ...
        this.preload = function () {
            ...
            game.load.spritesheet('bg', 'sprites/newBackground.png', 3800, 720);
...
//          game.load.spritesheet("player", "sprites/player.png", 32, 48);
            ...
            game.load.image('facebook', "sprites/Icones125x125/spriteFacebook.png", 125, 125);
            game.load.image('netflix', "sprites/Icones125x125/spriteNetflix.png", 125, 125);
            game.load.image('youtube', "sprites/Icones125x125/spriteYoutube.png", 125, 125);
            game.load.image('instagram', "sprites/Icones125x125/spriteInstagram.png", 125, 125);
            game.load.image('whatsapp', "sprites/Icones125x125/spriteWhatsApp.png", 125, 125);
            game.load.image('btnUp', "sprites/spriteBtnUp.png");
            game.load.image('btnDown', "sprites/spriteBtnDown.png");
        ...
        this.create = function () {
            ...
            background = game.add.tileSprite(0, 0, 3800, 720, 'bg');
            ...
            btnUp = game.add.sprite(1150, 480, 'btnUp');
            btnUp.inputEnabled = true;
            btnUp.alpha = 0.8;
            btnDown = game.add.sprite(1150, 600, 'btnDown');
        ...
        function agachar() {
            ...
            if (!morto && !jaPulou && !agachando) {
                ...
                agachando = true;
                somAgachar.play();
                player.body.setSize(110, 191, 63, 90);
            }
        }
        ...
        async function collisionHandler(player, icone) {
            ...
            game.add.tween(txtGameOver).to({
                y: 150
            }, 500).start();
            game.add.tween(txtScoreTela).to({
                x: game.world.centerX
            }, 500).start();
            game.add.tween(txtHighScore).to({
                x: game.world.centerX
            }, 500).start();
            game.add.tween(txtRestart).to({
                x: game.world.centerX
            }, 500).start();
            ...
            txtHighScore.setText("Distância Máxima: " + Global.distanciaMaior);
            if (distancia > Global.distanciaMaior) {
                Global.distanciaMaior = distancia;
                txtHighScore.setText("Distância máxima: " + Global.distanciaMaior);
                game.add.tween(txtNovoHighScore).to({
                    x: game.world.centerX
                }, 500).start();
            }
        }
        ...
        function liberaInstagram() {
            ...
            instagram.body.setCircle(62.5);
        }

        function liberaWhatsApp() {
            var whatsapp = grupoWhatsApp.getRandomNotExists();
            if (!whatsapp) {
                whatsapp = grupoWhatsApp.create(1320, 550, 'whatsapp');
